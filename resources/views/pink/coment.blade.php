...
<li class="comment even {{$item->user_id == $article->user_id ? 'bypostauthor odd' : ''}}" id="li-comment-{{$item->id}}">
        ...
        <div class="comment-meta commentmetadata">
            ...
            <div class="reply group">
                <a class="comment-reply-link" href="#respond"
                   onclick="return addComment.moveForm(&quot;comment-{{$item->id}}&quot;, &quot;{{$item->id}}&quot;, &quot;respond&quot;, &quot;{{$item->article_id}}&quot;)">Reply</a>
            </div>
            <!-- .reply -->
        </div>
    ...
    @if(isset($com[$item->id]))
        <ul class="children">
            @include(env('THEME').'.coment',['items'=>$com[$item->id]])
        </ul>
    @endif
</li>
@endforeach