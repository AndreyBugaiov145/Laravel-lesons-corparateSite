...
<head>
    ...
    <link rel="stylesheet" id="max-width-1024-css" href="{{asset(env('THEME'))}}/css/max-width-1024.css" type="text/css"
        ...
        @if(Route::currentRouteName()=='portfolios.index')
            <div id="page-meta">
                <div class="inner-group">
                    <h3>Welcome to portfolio page</h3>
                    <h4>... i hoe you enjoy my works</h4>
                </div>
            </div>
        @endif
